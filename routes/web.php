...
use App\Http\Controllers\cliente\ChatBotController;
...
Route::post('/eviar_det_rembolso', [UserAuthController::class, 'reembolso_create']);


Route::get('/',[ClienteController::class,'index']);
Route::get('/gerarpdf', [UserAuthController::class, 'gerarPdf']);
...
Route::post('/userLogin', [ClienteController::class, 'userLogin'])->name('login.user'); 
...
Route::get('/user/{id_voo}/{adult}/{lugares}/{crianca?}', [UserAuthController::class, 'teste']);
...
//permissao
Route::get('/admin/permissao', [PermissaoController::class, 'index'])->name('permissao.index');
Route::get('/admin/permissaoget/{id}', [PermissaoController::class, 'edit'])->name('permissao.edit'); 
Route::post('/admin/permissaoupdate', [PermissaoController::class, 'update'])->name('permissao.update'); 
Route::get('/admin/permissaodelete/{id}', [PermissaoController::class, 'destroy'])->name('permissao.delete');
Route::post('/admin/permissaoadd', [PermissaoController::class, 'store'])->name('permissao.add');
