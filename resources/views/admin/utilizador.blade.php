                ...
                <table class="table table-bordered">
                  ...
                  @foreach($utilizadores as $utilizador)
                    <tr>
                      ...
                      @endif
                      @if(($autorizacao->utilizador == 'ver')||($autorizacao->utilizador == 'tudo')||($autorizacao->utilizador== 'escrever/ler'))
                      ...
                      @if(($autorizacao->utilizador == 'eliminar')||($autorizacao->utilizador == 'tudo')||($autorizacao->utilizador== 'escrever/ler'))
